      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-56 md:pt-96">
        ...
        >
          <h1 className="text-white font-black tracking-tighter drop-shadow-2xl uppercase leading-tight">
            <span className="text-xs md:text-sm opacity-70 block tracking-[0.2em] mb-1">Bienvenue au</span>
            <span className="text-2xl md:text-4xl block">Centre <span className="text-gold">Factory</span></span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mt-1">
            <Link to="/formations">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-5 py-2.5 bg-gold text-black text-xs font-black uppercase tracking-widest rounded-full flex items-center gap-2 shadow-xl hover:bg-gold-light transition-colors"
              >
                Formations
                <ArrowRight size={16} />
              </motion.button>
            ...
            <Link to="/inscription">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-5 py-2.5 bg-white/10 backdrop-blur-md border border-white/20 text-white text-xs font-black uppercase tracking-widest rounded-full hover:bg-white/20 transition-colors"
              >
                S'inscrire
              </motion.button>
            </Link>
